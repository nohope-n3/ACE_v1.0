...
static esp_err_t message_handler(httpd_req_t *req) {
    ...
    // Read the incoming message from the request
    ...
    // Process the received message (for example, print it to the serial monitor)
    ...
    httpd_resp_send(req, "Message received", -1);
